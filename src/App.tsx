    ...
    <div className="App">
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p>En los apartados relativos al Tarot, se complementa con extractos de la misma bibliografía.</p>
          ...
          <ul>
            ...
            <li><strong>No Sustituye Asesoría Profesional:</strong> El contenido de esta web no debe entenderse como asesoría médica, psicológica, legal, espiritual o de cualquier otro ámbito.</li>
